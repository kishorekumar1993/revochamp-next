...
export function TipSection({ value }: { value: string }) {
  return (
    <div className="rounded-2xl overflow-hidden shadow-xl border border-green-200 bg-gradient-to-br from-green-50 to-emerald-50">
      <div className="border-l-4 border-green-600 p-6 lg:p-8">
        <div className="flex gap-4">
          <div className="text-3xl mt-1">💡</div>
          <div className="flex-1">
            <h4 className="font-bold text-green-900 mb-2">Pro Tip</h4>
            <div className="prose prose-sm max-w-none text-green-800 [&_strong]:text-green-700 [&_em]:text-green-600">
