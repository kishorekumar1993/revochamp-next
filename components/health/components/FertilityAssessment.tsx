...
export default function FertilityAssessment() {
  ...
  // Removed auto-scroll effect – no scrolling on question change
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-amber-50/30 via-white to-white">
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 md:py-12">
          {/* ========== STATIC CONTENT – ALWAYS VISIBLE TO GOOGLE ========== */}
          <section className="mb-12">
            <h1 className={`${playfair.className} text-4xl sm:text-5xl font-bold text-stone-800 mb-4`}>
              Free Fertility Test <span className="text-amber-600">for Couples</span>
            </h1>
            <p className={`${poppins.className} text-stone-600 text-lg mb-6`}>
              Answer 21 evidence‑based questions about female/male health, lifestyle, and timing – 
              get your fertility score, risk factors, and personalized tips in 2 minutes.
            </p>

            <div className="bg-amber-50/50 p-4 rounded-xl border border-amber-100 mb-8">
              <p className={`${poppins.className} text-sm text-amber-800`}>
                <strong>📋 Medical disclaimer:</strong> This tool is for educational purposes only and does not provide a medical diagnosis. 
                Always consult a qualified healthcare provider for personalized advice.
              </p>
            </div>

            <h2 className={`${playfair.className} text-2xl font-bold text-stone-800 mt-8 mb-4`}>
              What Affects Fertility?
            </h2>
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-white p-5 rounded-2xl shadow-sm border border-stone-100">
                <h3 className={`${poppins.className} text-lg font-semibold text-amber-700 mb-2`}>
                  Female Factors
                </h3>
            ...
            {/* Trust Signals – No fake claims, only factual statements */}
            <div className="border-t border-stone-200 pt-6 text-sm text-stone-500">
              <p>📚 Information based on sources: American College of Obstetricians and Gynecologists (ACOG), World Health Organization (WHO)</p>
              <p>
                🔗 <a href="/about" className="text-amber-600 hover:underline">About Revochamp</a> | 
                <a href="/privacy" className="text-amber-600 hover:underline ml-2">Privacy Policy</a>
              </p>
            </div>
          </section>

          {/* ========== INTERACTIVE QUIZ (always accessible) ========== */}
          {!showResult ? (
            <QuestionCard
          ...
          {/* ========== ADDITIONAL EDUCATIONAL CONTENT (always visible) ========== */}
          <div className="mt-20 border-t border-amber-100 pt-12">
            ...
            <div className="text-center mt-12">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a href="/tools/health/ovulation-calculator" className="bg-white border border-amber-200 text-amber-700 px-5 py-2 rounded-full hover:bg-amber-50 transition">
                  📅 Ovulation Calculator
                </a>
                <a href="/tools/health/pregnancy-calculator" className="bg-white border border-amber-200 text-amber-700 px-5 py-2 rounded-full hover:bg-amber-50 transition">
                  🤰 Pregnancy Due Date Calculator
                </a>
                <a href="/tools/health/bmi-calculator" className="bg-white border border-amber-200 text-amber-700 px-5 py-2 rounded-full hover:bg-amber-50 transition">
                  ⚖️ BMI Calculator
                </a>
                <a href="/blog/fertility-mistakes-to-avoid" className="bg-white border border-amber-200 text-amber-700 px-5 py-2 rounded-full hover:bg-amber-50 transition">
