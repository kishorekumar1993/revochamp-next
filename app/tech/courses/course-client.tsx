...
export default function CourseClient({ initialCourses, initialCategories }: Props) {
  ...
  const searchInputRef = useRef<HTMLInputElement>(null); // ✅ use ref instead of getElementById
  ...
  const showSnackbarMessage = (msg: string) => {
    ...
    const timeoutId = setTimeout(() => setSnackbar({ show: false, message: "" }), 3000);
  ...
  const startLearning = (course: Course) => {
    ...
    setTimeout(() => {
      // ✅ Fixed double slash: `/tech/${course.slug}`
  ...
  // Compute total stats (used if needed, though not displayed in current JSX)
      ...
      <header className="app-bar">
        <div className="container app-bar-content">
          ...
          <div className="app-bar-actions">
            <button className="icon-btn mobile-search-btn" onClick={focusSearchInput}>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="relative group p-1.5 bg-white border border-slate-200 rounded-2xl shadow-2xl shadow-slate-200/50 flex items-center transition-all focus-within:border-indigo-500 focus-within:ring-4 focus-within:ring-indigo-50">
                ...
                <input
                  ...
                  className="flex-1 py-3 bg-transparent outline-none ring-0 border-none focus:ring-0 focus:outline-none"
                  value={searchQuery}
        ...
        <div className="container">
          <div className="footer-content">
            ...
            <nav className="footer-links">
              ...
              <div className="footer-column">
                <h4>Connect</h4>
                <a href="https://twitter.com/revochamp" target="_blank" rel="noopener noreferrer">Twitter</a>
                <a href="https://linkedin.com/company/revochamp" target="_blank" rel="noopener noreferrer">LinkedIn</a>
                <a href="https://github.com/revochamp" target="_blank" rel="noopener noreferrer">GitHub</a>
              </div>
            </nav>
          </div>
