...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://revochamp.com/tools/finance",
    siteName: "FinTools",
    images: [
      {
        url: "https://revochamp.com/og-finance-tools.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://revochamp.com/og-finance-tools.png"],
  },
  alternates: {
  ...
  "mainEntity": {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 2,
        "name": "SIP Calculator",
        "url": "https://revochamp.com/tools/finance/sip-calculator",
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": "Income Tax Calculator",
        "url": "https://revochamp.com/tools/finance/income-tax-calculator",
      },
      {
        "@type": "ListItem",
        "position": 4,
        "name": "Home Loan Calculator",
        "url": "https://revochamp.com/tools/finance/home-loan-calculator",
      },
    ],
  },
};
