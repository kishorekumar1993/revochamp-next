// app/tools/car-loan-calculator/CarLoanCalculatorClient.tsx
"use client";
...
const carLoanPresets = [
  { name: "Hatchback", amount: 600000, rate: 9.0, years: 5 },
  { name: "Sedan", amount: 1200000, rate: 8.75, years: 7 },
  { name: "SUV", amount: 2000000, rate: 8.5, years: 7 },
  { name: "Luxury", amount: 5000000, rate: 8.25, years: 5 },
];
...
export default function CarLoanCalculatorClient() {
  ...
  const handlePreset = (preset: typeof carLoanPresets[0]) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50/30 via-white to-amber-50/20 text-slate-800">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-10 md:py-14">
        ...
        >
          ...
          <p className={`${poppins.className} text-base sm:text-lg text-slate-600 max-w-3xl mx-auto`}>
            Calculate your car loan EMI, total interest, and repayment schedule. Compare different loan
            amounts, interest rates, and tenures to find the best plan.
          </p>
        </motion.div>

        {/* Preset Cards */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-10">
          {carLoanPresets.map((preset) => (
            <button
              key={preset.name}
          ...
          <div className="lg:col-span-1 bg-white rounded-3xl shadow-xl border border-slate-200/80 p-6 md:p-7">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">Typical car loan rates: 8-10%</p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">Car loans typically have 1-7 year tenure.</p>
              </div>
            </div>
          </div>
              ...
              >
                ...
                <div className="p-4 bg-slate-50 border-t border-slate-200 text-center">
                  <p className="text-xs text-slate-500">
                    📉 Making prepayments in the first few years saves the most interest.
                  </p>
                </div>
              </motion.div>
            )}
        ...
        <div className="mt-10 bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-6 border border-orange-200">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-slate-800 mb-1">Smart Car Loan Tips</h3>
              <p className="text-sm text-slate-600">
                Compare rates across banks and NBFCs. A higher down payment reduces interest burden.
                Choose a shorter tenure if EMI is affordable – it saves significant interest. Check for
                prepayment charges and processing fees before finalising.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="border-t border-slate-200/60 py-8 mt-8 bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 text-center text-sm text-slate-500">
          © {new Date().getFullYear()} FinTools. Drive smart, finance smarter.
        </div>
      </footer>
    </div>
  );
