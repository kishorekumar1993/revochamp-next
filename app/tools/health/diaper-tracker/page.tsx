...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://revochamp.site/tools/health/diaper-tracker",
    siteName: "Revochamp",
    images: [
      {
        url: "https://revochamp.site/tools/health/og-diaper.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://revochamp.site/tools/health/og-diaper.png"],
  },
};
