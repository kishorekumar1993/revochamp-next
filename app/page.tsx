...
//   //   if (course) {
//   //     showSnackbarMessage(`🎓 Starting ${course.title}`);
//   //     if (course.title === "RevoChamp Learning") {
//   //       setTimeout(() => navigateToCourses(), 1000);
//   //     } else {
//   //       setTimeout(() => {
//   //         window.open('https://revochamp.site/blog/', '_blank');
//   //       }, 1000);
...
//     // Logic based on slug or ID
//     switch (course.slug) {
//       case "learning":
//         router.push("/tech/courses"); // Moves to tech/courses
//         break;
//       case "mock-interview":
//         router.push("/interview"); // Moves to interview screen
//         break;
//       case "tools":
//         router.push("/tools"); // Example: Moves to tools screen
//         break;
//       case "blog":
//         window.open("https://revochamp.site/blog/", "_blank");
//         break;
...
//     showSnackbarMessage("Navigating to all courses");
//     scrollToCourses();
//   };

//   const router = useRouter();
//   // ✅ Fixed navigation function using Next.js App Router
//   const navigateTo = (page: string) => {
//     // ✅ Correct
...
//   //     showSnackbarMessage(`Navigating to ${page} page`);
//   //   }
//   //   // showSnackbarMessage(`Navigating KK to ${page} page`);
...
//         <section className="hero-section">
//           <div className="container">
//             <span className="hero-badge">✨ 100% Free Learning</span>
//             <h1 className="hero-title">
//               From first line of code
//               <br />
//               to <span className="hero-title-gradient">your dream offer</span>
...
//               <div className="section-header">
//                 <h2>Search Results ({searchResults.length})</h2>
//                 <a className="view-all-link" onClick={navigateToCourses}>
//                   View All Courses →
//                 </a>
//               </div>
//               <div className="courses-grid">
...
//                 </p>
//               </div>
//               {/* <a className="view-all-link" onClick={navigateToCourses}>Browse All →</a> */}
//               <Link href="/tech/courses" className="view-all-link">
//                 Browse All →
//               </Link>
//             </div>
...
//                 in-demand tech skills for free
//               </p>
//               <button className="btn-primary-large" onClick={navigateToCourses}>
//                 Browse All Courses →
//               </button>
//             </div>
//           </div>
